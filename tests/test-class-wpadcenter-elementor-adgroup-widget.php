<?php
/**
 * Class Wpadcenter_Elementor_Adgroup_Widget_Test
 *
 * @package Wpadcenter
...
/**
 * Wpadcenter_Elementor_Adgroup_Widget class test cases.
 */
class Wpadcenter_Elementor_Adgroup_Widget_Test  extends WP_UnitTestCase {

	/**
	 * The Wpadcenter_Elementor_Adgroup_Widget class instance.
	 *
	 * @since  1.0.0
	 * @access public
	 * @var    string    $wpadcenter_elementor_adgroup_widget class instance.
	 */
	public static $wpadcenter_elementor_adgroup_widget;
	...
	public static function wpSetUpBeforeClass( WP_UnitTest_Factory $factory ) {
		...
		self::$wpadcenter_elementor_adgroup_widget = new Wpadcenter_Elementor_Adgroup_Widget();
	...
	public function test_get_name() {
		$value = self::$wpadcenter_elementor_adgroup_widget->get_name();
	...
	public function test_get_categories() {
		$value = self::$wpadcenter_elementor_adgroup_widget->get_categories();
	...
	public function test_register_controls() {
		...
		$this->assertArrayHasKey( 'num_ads', $all_controls, 'Failed to add num_ads control.' );
		$this->assertArrayHasKey( 'num_columns', $all_controls, 'Failed to add num_columns control.' );
	...
	protected static function getMethod( $name ) {
		$class  = new ReflectionClass( 'Wpadcenter_Elementor_Adgroup_Widget' );
	...
	public function test_get_adgroup_options() {
		$value = self::$wpadcenter_elementor_adgroup_widget->get_adgroup_options();
