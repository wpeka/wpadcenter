...
class Wpadcenter {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_notices', $plugin_admin, 'wpadcenter_ad_created_popup' );
		$this->loader->add_action( 'admin_init', $plugin_admin, 'wpadcenter_ad_created_popup_close', 5 );
	}
